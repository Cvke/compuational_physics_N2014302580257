# -*- coding: utf-8 -*-
"""
Created on Mon Oct 31 01:38:46 2016
...
def main():
	...
	theta_1 = change_amp(0.5,0.2,50)[0]

	t_1 = change_amp(0.5,0.2,50)[2]
	theta_2 = change_amp(1.2,0.2,50)[0]

	t_2 = change_amp(1.2,0.2,50)[2]



	plt.plot(t_0,theta_0,label='$F_D=0.00$,$q=0.2$')
	plt.plot(t_1,theta_1,label='$F_D=0.50$,$q=0.2$')
	plt.plot(t_2,theta_2,label='$F_D=1.20$,$q=0.2$')
