...
path1=paths.arc(radius=4.8,angle2=2*pi)
path2=[(10.5,0,10.5),(10.5,0,-10.5),(-10.5,0,-10.5),(-10.5,0,10.5),(10.5,0,10.5)]
table1=extrusion(pos=path1,shape=shape,material=materials.wood,color=color.cyan)
table2=extrusion(pos=path2,shape=shape,material=materials.wood,color=color.cyan)
table3=box(pos=(0,-1,0),size=(20,1,20),material=materials.wood)

taiqiu=sphere(pos=(7.5,0.5,0),radius=0.1,color=color.white,make_trail=True,material=materials.emissive)
taiqiu.tho=1
taiqiu.the=0
taiqiu.vtho=1
taiqiu.vthe=pi/12
