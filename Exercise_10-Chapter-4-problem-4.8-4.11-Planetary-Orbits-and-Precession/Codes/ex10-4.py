...
x1,y1,x2,y2,x3,y3 = [-5],[2],[10],[12.3],[-22],[-13]
...
plt.plot(x1,y1,label='Star 1',color="b")
plt.plot(x2,y2,label='Star 2',color="m")
plt.plot(x3,y3,label='Star 3',color="c")
plt.scatter([x1[-1],x2[-1],x3[-1]],[y1[-1],y2[-1],y3[-1]],color="r",s=50)
plt.scatter([x1[0],x2[0],x3[0]],[y1[0],y2[0],y3[0]],color="y",s=50)
