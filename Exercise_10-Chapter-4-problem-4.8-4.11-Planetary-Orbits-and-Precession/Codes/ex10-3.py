...
def plot():
	...
	plt.plot(x1,y1,label='$\\theta=45$°',color='b')
	plt.plot(x2,y2,label='$\\theta=90$°',color='m')
	plt.plot(x3,y3,label='$\\theta=135$°',color='c')
	...
	plt.xlabel('x/AU')
	plt.ylabel('y/AU')
	plt.title('Orbits for different initial angle')
	plt.show()
